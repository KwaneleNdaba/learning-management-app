...
import { Sidebar, SidebarContent, SidebarFooter, SidebarHeader, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarProvider, useSidebar } from './ui/sidebar';
...
function AppSidebar() {
    ...
    const navLinks = {
        student: [
            ...
            {
                icon: Briefcase, label: "Billing", href: "/user/billings"
            },
            {
        ...
        teacher: [
            ...
            {
                icon: DollarSign, label: "Billing", href: "/teacher/billings"
            },
            {
