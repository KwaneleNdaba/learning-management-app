...
export default function CoursePreview({ course }: CoursePreviewProps) {
    ...
    return (
        <div className='course-preview'>
            <div className="course-preview__container">
                <div className="course-preview__image-wrapper">
                    <Image
                        src={course.image || "/images/course-preview-placeholder"}
                        alt="course preview"
                        width={640}
                        height={360}
                        className='w-full'
            ...
            <div className="course-preview_-container">
                <h3 className="yext-xl mb-4">Price Details (1 item)</h3>
        ...
        ">
                ...
                <div className="flex justify-between mb-4 border-t border-customgreys-dirtyGrey pt-4
        ">
