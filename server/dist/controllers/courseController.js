...
const listCourses = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const courses = category && category !== "all" ? yield courseModel_1.default.scan("category").eq(category).exec()
...
const createCourse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.json({ message: "Course retrived successfully", data: newCourse });
    }
    catch (error) {
...
const updateCourse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        Object.assign(course, updateData); //replacing it with the new object or info
        yield course.save();
